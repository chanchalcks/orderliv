		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 md-margin-bottom-40">
					...
					<p class="margin-bottom-25 md-margin-bottom-40">Unify is an
						incredibly beautiful responsive Bootstrap Template for corporate
				...
				<div class="col-md-4">
					...
					<address class="md-margin-bottom-40">
						25, Lorem Lis Street, Orange <br /> California, US <br /> Phone:
						800 123 3456 <br /> Fax: 800 123 3456 <br /> Email: <a
			...
			<div class="row">
				<div class="col-md-6">
					<p class="copyright-space">
						2013 &copy; Unify. ALL Rights Reserved. <a href="#">Privacy
							Policy</a> | <a href="#">Terms of Service</a>
					</p>
				</div>
				<div class="col-md-6">
					<a href="index-2.html"> <img id="logo-footer"
						src="resources/assets/img/logo2-default.png" class="pull-right"
						alt="" />
					</a>
				</div>
			</div>
